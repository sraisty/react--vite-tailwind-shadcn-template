  ...
  return (
    <input
      ...
      className={cn(
        ...
        'focus-visible:ring3-[3px] focus-visible:ring3-neutral-950/50 focus-visible:border-neutral-950 dark:focus-visible:border-neutral-300 dark:focus-visible:ring-neutral-300/50',
        'dark:aria-invalid:ring3-red-500/40 dark:aria-invalid:ring3-red-900/20 dark:dark:aria-invalid:ring3-red-900/40 aria-invalid:border-red-500 aria-invalid:ring-red-500/20 dark:aria-invalid:border-red-900',
        className
      )}
      {...props}
    />
